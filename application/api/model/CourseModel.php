...
class CourseModel extends Model
{
    ...
    public function validate($data){
        $title_is_open=db('video_length')->field('is_open,length')->where('id=3')->find();
        $content_is_open=db('video_length')->field('is_open,length')->where('id=4')->find();
        if(($title_is_open['is_open']=='0'||$title_is_open['length']=='0')&&($content_is_open['is_open']=='0'||$content_is_open['length']=='0')){
            $validate = new validate([
                'title'  => 'require',
                'content'  => 'require',
            ],[
                'title.require'  => '请输入作业标题',
                'content.require'  => '请上传作业内容',
            ]);
            ...
            $validate = new validate([
                ...
                'title.require'  => '请输入作业标题',
                'content.require'  => '请上传作业内容',
                'content.max'  => '作业内容字符限制'.$content_is_open['length'],
            ]);
            ...
            $validate = new validate([
                ...
                'title.require'  => '请输入作业标题',
                'content.require'  => '请上传作业内容',
                'content.max'  => '作业内容字符限制'.$title_is_open['length'],
            ]);
        }else{
            $validate = new validate([
                ...
                'title.require'  => '请输入作业标题',
                'title.max'  => '作业标题字符限制'.$title_is_open['length'],
                'content.require'  => '请上传作业内容',
                'content.max'  => '作业内容字符限制'.$content_is_open['length'],
            ]);
        }
