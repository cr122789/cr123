...
class UpFiles extends Common
{
    public function upload(){
        ...
        // 移动到框架应用根目录/public/muke/public/uploads/ 目录下
        ...
        if($info){
            ...
            $result['url'] = '/muke/public/uploads/'. $path;
            return $result;
        }else{
            // 上传失败获取错误信息
    ...
    public function file(){
        ...
        if($info){
            ...
            $result['url'] = 'https://home.htlocalservice.com/miniPro/public/uploads/'. $path;
    ...
    public function editUpload(){
        ...
        if($info){
            $path=str_replace('\\','/',$info->getSaveName());
            return '/muke/public/uploads/'. $path;
        }else{
            // 上传失败获取错误信息
            $result['code'] =1;
            $result['msg'] = '图片上传失败!';
    ...
    public function upImages(){
        ...
        if($info){
            ...
            $result['msg'] = '图片上传成功!';
            $path=str_replace('\\','/',$info->getSaveName());
            $result["src"] = '/muke/public/uploads/'. $path;
            return $result;
        }else{
            // 上传失败获取错误信息
            $result['code'] =1;
