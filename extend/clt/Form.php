...
class Form{
    ...
    public function title($info,$value){
        ...
        $titleThumb =$title_thumb?$title_thumb:"/basic/public/static/admin/images/tong.png";
    ...
    public function image($info,$value){
        ...
        $action = ACTION_NAME;
        if($action=='add'){
            $value =$value?__PUBLIC__.$value:"/basic/public/static/admin/images/tong.png";
        }else{
            if($this->data[$field]){
                $value = $value ?$value : $this->data[$field];
            }else{
                $value = "/basic/public/static/admin/images/tong.png";
            }
        }
    ...
    public function file($info,$value){
        ...
        if($action=='add' or $ext==''){
            $value ="/basic/public/static/common/images/file.png";
        }else{
            $value = "/basic/public/static/common/images/".$ext.".png";
        }
                        ...
                        layui.use('upload', function () {
                            ...
                            upload.render({
                                ...
                                ext: '".$info['setup']['upload_allowext']."', 
                                    ...
                                    $('#".$field."File').attr('src', '/basic/public/static/common/images/'+res.ext+'.png');
